...
public final class ImageUtil {
	 ...
	 * @param x
	 *            水印图片距离目标图片左侧的偏移量，如果x<0, 则在正中�?
	 * @param y
	 *            水印图片距离目标图片上侧的偏移量，如果y<0, 则在正中�?
	 * @param alpha
	 *            透明�?0.0 -- 1.0, 0.0为完全�?明，1.0为完全不透明)
	 */
	 ...
	 *            字体颜色
	 * @param x
	 *            水印文字距离目标图片左侧的偏移量，如果x<0, 则在正中�?
	 * @param y
	 *            水印文字距离目标图片上侧的偏移量，如果y<0, 则在正中�?
	 * @param alpha
	 *            透明�?0.0 -- 1.0, 0.0为完全�?明，1.0为完全不透明)
	 */
	...
	/**
	 * 获取字符长度，一个汉字作�?1 个字�? �?��英文字母作为 0.5 个字�?
	 * 
	 * @param text
